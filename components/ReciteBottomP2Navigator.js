...
let ReciteBottomP2Navigator = React.createClass({
  render: function() {
    //default for step: 5
    let prevNavigator = (
    ...
    if (this.props.reciteStep !== 2) {
      if (this.props.context.isLast) {
        if (this.props.reciteStep === 3) {
          nextNavigator = (
            <TouchableHighlight style={ styles.navarrow } onPress={ this.props.finishPartHandler }>
...
export default ReciteBottomP2Navigator;
